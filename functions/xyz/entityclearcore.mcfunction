...
execute at @e[type=!player,scores={count=200 ..},c=1] run execute at @a run tellraw @s {"rawtext":[{"text":"§f[§aImpulse AntiCh§f] §eAll Entities Cleared!"}]}
kill @e[scores={count=200 ..}]
